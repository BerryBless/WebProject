...
description: ".NET 10 서버 hot path에 ValueTask·ReadOnlySpan<T>·ArrayPool<T>.Shared 적용을 강제한다. 잘못된 Task 반환, Substring 복사, 미풀링 버퍼, ArrayPool 소유권 위반을 탐지하고 교체 코드를 제시한다."
