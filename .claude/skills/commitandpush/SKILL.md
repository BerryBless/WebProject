---
name: commitandpush
description: "보안 검증 → 한국어 커밋 메시지 생성 → 커밋·푸시 파이프라인. 트리거: '/commitandpush', '커밋해줘', '커밋하고 푸시해줘', '변경사항 올려줘', '깃 커밋', '깃 푸시', 'git commit and push'. 후속: '다시 커밋해줘', '푸시만 다시', '보안 재검사 후 커밋'. 민감 정보 감지 시 커밋 차단."
---
