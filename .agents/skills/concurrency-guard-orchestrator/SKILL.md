...
description: ".NET 10 서버의 동시성·락·데드락 종합 감사 오케스트레이터(Lock-Free 강제, 락 정당화 감사, 데드락 생성-검증). 트리거(감사 의도 명시 시): '동시성 검사', '락 감사', '데드락 분석', 'Lock-Free 검증', 'async 데드락', '컨텐션 분석'. 후속: '다시 분석', '데드락만 재검토', '락 정당화 재감사'."
---
