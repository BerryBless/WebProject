...
/// <item><description><b>Concurrency:</b> <c>postgres</c> 컬렉션에 속해 같은 컬렉션의 다른 테스트 클래스와는 순차 실행되지만, 클래스 내부의 <see cref="Theory"/> 케이스들은 같은 팩토리·클라이언트를 공유하지 않아 서로 간섭하지 않는다.</description></item>
/// </list>
/// </remarks>
[Collection("postgres")]
