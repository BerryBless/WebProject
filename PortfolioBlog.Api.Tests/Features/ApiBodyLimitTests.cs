...
/// <b>[성능 및 동시성 제약 조건]</b>
/// <list type="bullet">
/// <item><description><b>Thread Context:</b> xUnit 테스트 스레드에서 실행되며, 각 케이스가 <see cref="ApiFactory.CreateLoggedInClientAsync"/>·<see cref="ApiFactory.CreateAdminClient"/>로 실제 로그인 왕복을 거친 클라이언트를 만든다.</description></item>
