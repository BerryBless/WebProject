...
| plan/mysql_migration_0926.md | 2026-09-26 | MySQL 전환 설계 스펙(**완료, PR #7 병합**): PG 통제 → MySQL 대체표 D1~D19, 질문 없이 내린 판정 R1~R6, 오류 번호 대응표(2.4절), ADR-011 초안(공개 조회 롤 재구현) |
...
| plan/mysql_migration_report_0927.md | 2026-09-27 | MySQL 전환 실행 보고서: 스파이크(Oracle no-go → Pomelo+EF 9), 태스크별 커밋·결과, 리뷰·변이 검사가 찾은 결함, 판정 22건, 교훈, 비용(코드 ~$110, 문서화 ~$150+ 중단), 남은 일(docs/generated·EF 9 종료 2026-11-10) |
